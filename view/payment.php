  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light color_arzyz">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="dashboard.php" class="nav-link letra_iconos_blancos">Start</a>
      </li>
      <!-- <li class="nav-item d-none d-sm-inline-block">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header bg-success">Invoices in Payment Process</div>
              <div class="card-body">
                <div class="row" id="cargando_tabla">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 centrar_texto">
                    <img id="cargando_table_payment" class="cargando_tablas" src="../assets/img/loading.gif">
                  </div>
                </div>
