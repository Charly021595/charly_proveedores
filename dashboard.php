    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="view/pago.php" class="nav-link">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
            <div class="card">
              <div class="card-header bg-success">Facturas Pendientes</div>
              <div class="card-body">
                ...
                <div class="row" id="mostrar_facturas_pendientes" style="display:none;">
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <table id="tabla_facturas_pendientes" class="table table-hover table-bordered
              ...
              <div class="modal-body">
                <form action="" id="form_cargar_facturas" enctype="multipart/form-data">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtRemision" name="txtRemision" disabled>
                    </div>
                  </div>
                  <div class="row form-group" style="display:none;">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtFechaOc" name="txtFechaOc" disabled>
                    </div>
                  </div>
                  <div class="row form-group" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtRfc" name="txtRfc" disabled>
                    </div>
                  </div>
                  <div class="row form-group" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtTotal" name="txtTotal" disabled>
                    </div>
                  </div>
                  <div class="row form-group" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtSubtotal" name="txtSubtotal" disabled>
                    </div>
                  </div>
                  <div class="row form-group" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtRfcEmpresa" name="txtRfcEmpresa" disabled>
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="text" class="form-control" id="txtMonedaDetalleT" name="txtMonedaDetalleT" disabled>
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="file" name="fileToUpload" id="XmlToUpload" name="XmlToUpload" class="btn" accept=".xml" onchange="validar_input_file(this)" required="">
                    </div>
                  </div>
                  <div class="row form-group">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="file" name="pdfToUpload" id="pdfToUpload" name="pdfToUpload" class="btn" accept=".pdf" onchange="validar_input_file(this)" required="">
                    </div>
                  </div>
                  ...
                  <div class="row form-group" id="info_carta_porte" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <label for="fileToUploadEvidencia">Información de Carta Porte separada:</label>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <input type="checkbox" id="cartaPrt" name="cartaPrt" value="chkboxCartaPorte" class="checkCartaPorte" onchange="validaCheck()">
                    </div>
                  </div>
                  ...
                  <div class="row form-group" id="carta_porte_xml" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <label for="xmlCartaPorteToUpload">Carta Porte XML:</label>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="row form-group" id="carta_porte_pdf" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <label for="pdfCartaPorteToUpload">Carta Porte PDF:</label>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="row form-group" id="carta_porte_evidencia" style="display:none;">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                      <label for="evidenciaPDFCpte">Evidencia:</label>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <!-- <div class="alert alert-warning-soft alert-dismissible" role="alert">  
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>  
                    <strong> Favor de validar que el nombre de los documentos no tengan espacios ni caracteres especiales. </strong>
                  </div> -->
                </form>
              </div>
                ...
                <form action="" id="form_factura_detalle" enctype="multipart/form-data">
                  ...
                  <div class="row form-group" id="div_tabla_detalle_factura">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <table id="tabla_detalle_factura" class="table table-hover table-bordered table-striped
                      table-responsive-xs table-responsive-sm" style="width: 100%;">
                        <thead>
                          <tr>
...
<!-- <script src="assets/js/PortalProveedores.js?t=<?=time()?>"></script> -->
</body>
</html>
